...
const getAllContrato = async (req, res) => {
    const response = await con.query(`
        ...
        b.objeto_contratacion, b.sede_trabajo, c.qr, b.objeto_contratacion, d.cargo, f.id_direccion, f.sigla
        FROM  contrataciones.formulario_contrataciones a, contrataciones.terminos_referencias b,
        contrataciones.contrato c, postulaciones.pos_cuadro_eq d, public.seg_usuario e, public.direcciones f
        ...
        AND b.id_usuarios = e.id_usuario
